...
'''
                ...
                if selection == 1:
                    query = 'App-webs 200 OK and location.country_code:IT'
                elif selection == 2:
                    pass
                    #query = 'login.rsp'
                elif selection == 3:
                    ...
                    query = 'My-Home bticino and location.country_code:IT'
                elif selection == 5:
                    query = 'linux upnp avtech and location.country_code:IT'
                elif selection == 6:
                    query = 'GoAhead 5ccc069c403ebaf9f0171e9517f40e41 and location.country_code:IT'
                elif selection == 7 or selection == 3:
                    query = '80.http.get.headers.server:Boa 0.94.14rc21 and location.country_code:IT'
                elif selection == 8:
